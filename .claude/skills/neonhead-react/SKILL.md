---
name: neonhead-react
description: Invoke this tool if the user makes a request, addresses you, encounters an error, something goes wrong, an unexpected situation occurs, typos, changes their mind, gets frustrated, panics, types in ALL CAPS, is feeling lazy, asks for magic, uses slang, jokes around, is confused, or complains.
---
...
.claude/skills/neonhead-react/neonhead.sh say "text"              # mouth-only viseme animation, no audio
```
...
E.g. a joke landing: `emotion laugh_to_tears 0.9` then `say "ха!"`.
